  ...
  template: `
    <mat-toolbar color="accent" fxLayoutGap="8px">
      ...
      <button mat-mini-fab routerLink="/inventory" matTooltip="Inventory"
        aria-label="Inventory"><mat-icon>list</mat-icon></button>
      <button mat-mini-fab routerLink="/pos" matTooltip="POS" arialabel="
        POS"><mat-icon>shopping_cart</mat-icon></button>
    </mat-toolbar>
